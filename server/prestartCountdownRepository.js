...
const DEFAULT_DATA_PATH = path.join(__dirname, "../data/prestart-countdown.json");
...
function normalizeStartedAt(startedAt) {
  ...
  if (!Number.isFinite(timestamp)) {
    throw createHttpError(400, "Prestart countdown startedAt must be a valid timestamp.");
  }
...
function createPrestartCountdownRepository(dataPath = DEFAULT_DATA_PATH) {
...
module.exports = {
  DEFAULT_PRESTART_COUNTDOWN_DURATION_MS: DEFAULT_DURATION_MS,
  createPrestartCountdownRepository,
};
