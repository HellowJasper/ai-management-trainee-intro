...
function isIntroPlaybackActive() {
  return !explicitScreenViewRoute && (appView === "intro" || appShell.dataset.view === "intro" || appShell.dataset.view === "intro-exit" || isIntroExiting);
}
